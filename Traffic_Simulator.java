...
public class Traffic_Simulator extends JFrame implements Runnable,ActionListener {
    private Vehicle Vehicle_Container[]=new Vehicle[30];
    ...
    public void check() {
        for(int j=0;j<total;j++) {
            if(Vehicle_Container[j].check) {
                for(int k=j;k<total;k++) {
                    Vehicle_Container[k]= Vehicle_Container[k+1];
                }
                total--;
            }
    ...
    public void addTraffic(int index, int i) {
        if(index>0 & index<=2) {
            ...
            CityContainer[i].addTraffic(new Road(310, 117,true,false,true));
            CityContainer[i].addTraffic(new Road(372, 60,true,false,false));
            CityContainer[i].addTraffic(new Road(372, 150,true,false,false));
            CityContainer[i].addTraffic(new Road(395, 117,true,false,true));
        }
            ...
            CityContainer[i].addTraffic(new Road(372, 150,true,false,false));
            CityContainer[i].addTraffic(new Road(395, 117,true,false,true));
            CityContainer[i].addTraffic(new Road(372, 445,true,false,false));
        }
        else if(index>6 &  index<=8) {
            traffic =new Road(310, 117,true,false,true);
            CityContainer[i].addTraffic(traffic);
            traffic =new Road(372, 60,true,false,false);
            CityContainer[i].addTraffic(traffic);

            traffic =new Road(372, 150,true,false,false);
            CityContainer[i].addTraffic(traffic);
            traffic =new Road(395, 117,true,false,true);
            CityContainer[i].addTraffic(traffic);

            traffic =new Road(170, 445,true,false,false);
            CityContainer[i].addTraffic(traffic);
            traffic =new Road(372, 445,true,false,false);
            CityContainer[i].addTraffic(traffic);
            traffic =new Road(672, 445,true,false,false);
            CityContainer[i].addTraffic(traffic);
        }
        else {
            City.addRoad(new Road(310, 117,true,false,true));
            City.addRoad(new Road(372, 60,true,false,false));

            City.addRoad(new Road(372, 150,true,false,false));
            City.addRoad(new Road(395, 117,true,false,true));

            City.addRoad(new Road(170, 445,true,false,false));
            City.addRoad(new Road(372, 445,true,false,false));
            City.addRoad(new Road(672, 445,true,false,false));}
    }
    public void addVehicle(int index,int i) {
        if(index>0 & index<=2) {
            Vehicle_Container[total]=new Bus(804, 135);
            Vehicle_Container[total].turn3();
            CityContainer[i].addVehicle(Vehicle_Container[total]);
            total++;
        }
        else if(index>2 & index<=4) {
            ...
            if(a==0) {
                ...
                Vehicle_Container[total]=new Car(354, 0);
                Vehicle_Container[total].turn1();
                CityContainer[i].addVehicle(Vehicle_Container[total]);
                total++;}
        }
        else if(index>4 & index<=6) {
            ...
            if(a==0) {
                ...
                Vehicle_Container[total]=new MotorBike(385, 580);
                Vehicle_Container[total].turn2();
                CityContainer[i].addVehicle(Vehicle_Container[total]);
                total++;}
            else if(a==3) {

                Vehicle_Container[total]=new Car(0, 404);
            ...
            if(a==0) {
                ...
                Vehicle_Container[total]=new MotorBike(185, 580);
                Vehicle_Container[total].turn2();
                City.addVehicle(Vehicle_Container[total]);
                total++;}

            else if(a==5) {
                Vehicle_Container[total]=new MotorBike(685, 580);
                Vehicle_Container[total].turn2();
                City.addVehicle(Vehicle_Container[total]);
                total++;}
        }
            ...
            if(a==0) {
                ...
                Vehicle_Container[total]=new Car(385, 580);
                Vehicle_Container[total].turn2();
                City.addVehicle(Vehicle_Container[total]);
                total++;}
                ...
                Vehicle_Container[total]=new Bus(810, 135);
                Vehicle_Container[total].turn3=true;
                City.addVehicle(Vehicle_Container[total]);
                total++;}
            else {
                Vehicle_Container[total]=new Bus(0, 404);
                City.addVehicle(Vehicle_Container[total]);
                total++;}
